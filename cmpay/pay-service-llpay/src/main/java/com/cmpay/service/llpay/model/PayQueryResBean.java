...
public class PayQueryResBean implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -8553723187098266529L;
	...
	public String toString() {
		return "PayQueryResBean [ret_code=" + ret_code + ", ret_msg=" + ret_msg
				+ ", sign_type=" + sign_type + ", sign=" + sign
				+ ", result_pay=" + result_pay + ", oid_partner=" + oid_partner
				+ ", dt_order=" + dt_order + ", no_order=" + no_order
				+ ", oid_paybill=" + oid_paybill + ", money_order="
				+ money_order + ", settle_date=" + settle_date
				+ ", info_order=" + info_order + ", pay_type=" + pay_type
				+ ", bank_code=" + bank_code + "]";
	}
