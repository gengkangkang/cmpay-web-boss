...
public class CashQueryResBean implements Serializable{
	...
	private String result_pay;//支付结果  SUCCESS 代付成功    PROCESSING 银行代付处理中  WAITING 等待支付 FAILURE 代付失败REFUND 代付退款当批付提现发生内部退款。及在代付成功后，会有可能会发生退款交易 支付结果以此为准，商户按此进行后续是否发货操作
