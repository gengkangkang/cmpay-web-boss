...
public class CpSinPayQueryRespDef implements Serializable{
	
    /**
	 * 
	 */
	private static final long serialVersionUID = 2476619102340826730L;
	...
	public String toString() {
		return "CpSinPayQueryRespDef [code=" + code + ", merId=" + merId
