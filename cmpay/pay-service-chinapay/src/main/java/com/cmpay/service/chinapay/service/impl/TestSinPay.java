...
public class TestSinPay {
	...
	public static void main(String[] args) throws Exception {
		//单笔代付若采用POST传输方式且HTTPCLIENT为4.X版本，中文传Unicode值         httpclient  3.1
		//我司单笔代付若采用POST传输方式且HTTPCLIENT为3.X版本，中文直接传中文；单笔代付若采用GET传输方式且HTTPCLIENT为3.X版本，中文传Unicode值；
		//单笔代付若采用POST传输方式且HTTPCLIENT为4.X版本，中文传Unicode值。我处看贵司请求报文中的中文都是Unicode值，请确认使用的HTTPCLIENT版本。
		//封装代付请求
		CpSinPayReq req = new CpSinPayReq();
		req.setMerId("808080211389035");
		req.setMerDate("20160121");//标志该笔交易发生的日期,格式为YYYYMMDD，请填写当天的日期。
		req.setMerSeqId("0000000001112002");//商户号+商户流水号+商户日期唯一标示一笔交易订单
...
//		String version = "20090501";
//		String merId = "808080211389035";
//		String merDate = "20151231";
//		String merSeqId = "0000000000111191";
//		String version = "20090501";
...
//			System.out.println("plainData1:"+plainData1);
//			String str = toGBK(plainData1);
