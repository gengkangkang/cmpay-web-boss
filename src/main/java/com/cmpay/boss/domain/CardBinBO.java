...
public class CardBinBO extends BaseBO{
		...
		public String toString() {
			return "CardBinBO [cardBin=" + cardBin + ", cardLength=" + cardLength + ", cardType=" + cardType
					...
					+ ", cmpayCode=" + cmpayCode + ", cmpayName=" + cmpayName + ", field=" + field + ", field1="
					+ field1 + ", field2=" + field2 + ", modifier=" + modifier + ", modifyTime=" + modifyTime + "]";
		}
