...
public class CmpaySuppBankMap {
	...
	public String toString() {
		return "CmpaySuppBankMap [id=" + id + ", pcBankCode=" + pcBankCode + ", pcBankName=" + pcBankName
				+ ", payChannelCode=" + payChannelCode + ", payBankCode=" + payBankCode + ", singleMaxAmount="
				+ singleMaxAmount + ", singleMinAmount=" + singleMinAmount + ", dayMaxAmount=" + dayMaxAmount
				+ ", dayMaxTimes=" + dayMaxTimes + ", monthMaxAmount=" + monthMaxAmount + ", monthMaxTimes="
				+ monthMaxTimes + ", status=" + status + ", creator=" + creator + ", createTime=" + createTime
				+ ", modifier=" + modifier + ", modifyTime=" + modifyTime + ", version=" + version + ", remark="
				+ remark + "]";
	}
}