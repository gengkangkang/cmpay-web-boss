...
<!--     <form id="pagerForm" name="merForm" data-toggle="ajaxsearch" action="#" method="post">
 ...
 -->          
        <div class="bjui-searchBar">
            ...
            <a href="${pageContext.request.contextPath}/bankManagement/addBankBase" class="btn btn-green" data-toggle="dialog" data-width="400" data-height="400" data-id="dialog-normal" data-title="新增渠道">新增银行</a>
    ...
    <table  class="table table-bordered table-hover table-striped table-top" data-toggle="tablefixed" data-width="100%" data-nowrap="true">
        ...
        <tbody>
    <c:forEach var="record" items="${bankBaseForm.pagination.list}" varStatus="status">
    <tr data-id="<c:out value="${record.id}"/>">
        ...
        <td align="center">
            <a href="${pageContext.request.contextPath}/bankManagement/editBB?sid=<c:out value="${record.id}"/>" class="btn btn-green" data-toggle="dialog" data-width="800" data-height="400" data-id="dialog-normal" data-title="资源信息">修改</a>
        </td>
        </tr>
    </c:forEach>
        </tbody>
    ...
    <div class="pages">
        ...
        <span> 条，共 <c:out value="${bankBaseForm.pagination.itemCount}"/> 条</span>
    </div>
    <div class="pagination-box" data-toggle="pagination" data-total="<c:out value="${bankBaseForm.pagination.itemCount}"/>" data-page-size="<c:out value="${bankBaseForm.pageSize}"/>" data-page-current="<c:out value="${bankBaseForm.pageCurrent}"/>">
    </div>
    </div>
