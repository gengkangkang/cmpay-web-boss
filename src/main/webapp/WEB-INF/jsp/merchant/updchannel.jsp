...
<div class="bjui-pageContent tableContent">
 <form id="pagerForm" name="payChannelForm" data-toggle="validate" novalidate="novalidate" action="${pageContext.request.contextPath}/channelManagement/updateChannel" method="post">
    <div class="bjui-searchBar">
          <input type="hidden" name="id"  value="${payChannelForm.id}" />&nbsp;    
      <div class="form-group" style="margin: 20px 0 20px; ">
      <label class="control-label x85">渠道编号：</label>
      <input type="text"  name="code" value="${payChannelForm.code}" style="width:60%;" data-rule="渠道编号:required;" />&nbsp;
      </div>
      <div class="form-group" style="margin: 20px 0 20px; ">
      <label class="control-label x85">渠道名称：</label>
      <input type="text"  name="name" value="${payChannelForm.name}" style="width:60%;" data-rule="渠道名称:required;" />&nbsp;
      </div>
    ...
    <div class="form-group" style="margin: 20px 0 20px; ">
       <label class="control-label x85">开启状态：</label>       
       <select name="openStatus" data-toggle="selectpicker" data-rule="required">  
   ...
   <div class="form-group" style="margin: 20px 0 20px; ">
    ...
    <div class="form-group" style="margin: 20px 0 20px; ">
      ...
      <input type="text"  name="remark" value="${payChannelForm.remark}" style="width:60%;" />
      </div>
